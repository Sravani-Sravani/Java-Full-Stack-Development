...
public class ViewCustomersServlet extends HttpServlet 
{
	public void service(HttpServletRequest req, HttpServletResponse res) throws IOException
	{
	    ...
	    out.println("<style type=\"text/css\">\r\n" + 
	    		...
	    		"<h><h><br><br>\r\n" + 
	    		"<a href=\"superadminhome.html\" class=\"btn\" style=\"font-weight:bold;font-size:15px\">Home</a>\r\n" + 
	    		"    <a href=\"addtheatre.html\" class=\"btn\" style=\"font-weight:bold;font-size:15px\">Add Theatres</a>\r\n" + 
	    		"    <a href=\"addtmanager\" class=\"btn\" style=\"font-weight:bold;font-size:15px\">Add Managers</a>\r\n" + 
	    		"    <a href=\"addmovie.html\" class=\"btn\" style=\"font-weight:bold;font-size:15px\">Add Movies</a>\r\n" + 
	    		"    <a href=\"viewcustomers\" class=\"btn\" style=\"font-weight:bold;font-size:15px\">View Customers</a>\r\n" + 
	    		"      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n" + 
	    		"    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n" + 
	    		"    <a href=\"superadminlogin.html\" class=\"btn\" style=\"font-weight:bold;font-size:15px\">Logout</a>\r\n" + 
	    		"   <br>\r\n" + 
	    		"<br>");	
		...
		try
		{
			...
			while(rs.next())
			{
				out.println("<div class=\"table-content\">	\r\n" + 
						...
						"				<div class=\"table-data\">"+rs.getString(3)+"</div>\r\n" + 
						"				<div class=\"table-data\">"+rs.getString(4)+"</div>\r\n" + 
						"				<div class=\"table-data\">"+rs.getString(5)+"</div>\r\n" + 
						"				<div class=\"table-data\">"+rs.getString(7)+"</div>\r\n" + 
						"				<div class=\"table-data\">"+rs.getString(8)+"</div>\r\n" + 
						"			</div>\r\n" + 
						"		</div>	");
			}
		}
